    ...
    public function run(): void
    {
        $posts = [
           [
            ...
            [
                'title' => 'O que é a Terapia Cognitivo-Comportamental Infantil?',
                'content' => "A TCC infantil foca em ajudar a criança a identificar e modificar padrões de pensamentos e comportamentos que geram sofrimento. É uma abordagem prática e colaborativa, onde a criança aprende a lidar com ansiedade, medos e frustrações de maneira saudável.\n\nUtilizamos jogos e dinâmicas para que o processo seja compreensível e eficaz para os pequenos.",
