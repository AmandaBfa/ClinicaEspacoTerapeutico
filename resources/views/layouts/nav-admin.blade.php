<nav class="bg-orange-50/80 backdrop-blur-md fixed top-0 w-full z-50 border-b border-orange-100" x-data="{ open: false }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-24">
            ...
            <div class="flex items-center">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2">
                    <img src="{{ asset('assets/images/logo2.png') }}" class="w-12 h-12 md:w-14 md:h-14 mix-blend-multiply"
                        alt="Logo">
                    {{-- Texto some no mobile (hidden), aparece no desktop (sm:block) --}}
            ...
            {{-- Centro: Menu de Gestão Unificado --}}
            <div class="relative group">
                ...
                <div
                    ...
                    {{-- Seção de Atalhos Rápidos (Aparece no dropdown no mobile) --}}
            ...
            <div class="flex items-center gap-2">
                {{-- Botão "Ver Site" fixo no Desktop, some no mobile (pois foi para o dropdown acima) --}}
                <a href="{{ route('home') }}"
